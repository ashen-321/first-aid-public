...
os.environ['PUBMED_EMAIL'] = 'alfredcs919@gmail.com'
...
def configure_clients() -> Tuple[PubMedClient, FullTextClient]:
    ...
    api_key = os.environ.get("pubmed_api_token")
...
async def list_tools() -> list[types.Tool]:
    ...
    logging.info("Listing tool description.")
...
async def call_tool(name: str, arguments: Dict[str, Any]) -> list[types.TextContent]:
    ...
    logging.info(f"Performing tool call with parameters: {locals()}")
